...
{
    InfoDialog.setCurrentLableText(ui->label->text(), "Выбирите материал из рекомендуемых, либо добавьте свой на кнопку добавить, после чего нажмите на кнопку обновить, чтобы он появился в выпадающем списке");
    InfoDialog.show();
}
